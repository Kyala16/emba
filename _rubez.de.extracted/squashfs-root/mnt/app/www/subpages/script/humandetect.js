$(document).ready(function () {
  ...
  function fun_multilang_adapter() {
    ...
    translate_page_item(TARGET_PAGE_SUB_AVANALYSIS, 'showid', 'label_humandct_showid_name', ITEM_TYPE_TEXT);
    translate_page_item(TARGET_PAGE_SUB_AVANALYSIS, 'targetmask', 'label_humandct_tagmask_name', ITEM_TYPE_TEXT);
    translate_page_item(TARGET_PAGE_SUB_AVANALYSIS, 'scenemode', 'div_humandct_scene_name', ITEM_TYPE_TEXT);
    ...
    var indoorhuman = translate_page_item(TARGET_PAGE_SUB_AVANALYSIS, 'indoorhuman', '', ITEM_TYPE_NONE);
    var outdoorhuman = translate_page_item(TARGET_PAGE_SUB_AVANALYSIS, 'outdoorhuman', '', ITEM_TYPE_NONE);
    var outcar = translate_page_item(TARGET_PAGE_SUB_AVANALYSIS, 'humanandcar', '', ITEM_TYPE_NONE);
  ...
  function fun_get_schedule_parameters() {
    ...
    sdk_getipcparam('/action/get?subject=alarm&type=12', function (result) {
      if (result != false) {
        $xml = $(result);
  ...
  function fun_get_base_parameters() {
    sdk_getipcparam('/action/get?subject=persondetect', function (result) {
      if (result === false) {
        return;
      }
      $xml = $(result);
  ...
  function fun_save_schedule() {
    ...
    var targetxml =
      ...
      '</alarmevt>' +
      '</request>';
    sdk_setipcparam('/action/set?subject=alarm&type=12', targetxml, function (result) {
  ...
  function fun_on_base_save() {
    var drawmask, confidence, scenemode, showid;
    var points = null;
    ...
    var showmask = $('#check_humandct_tagmask').prop('checked') ? 1 : 0;
    ...
    sdk_setipcparam('/action/set?subject=persondetect', targetxml, function (result) {
      var strsuc = translate_page_item(TARGET_PAGE_TIPSTEXT, 'infosave', '', ITEM_TYPE_NONE);
      var failed = translate_page_item(TARGET_PAGE_TIPSTEXT, 'errset', '', ITEM_TYPE_NONE);
      var auth = translate_page_item(TARGET_PAGE_TIPSTEXT, 'errauthority', '', ITEM_TYPE_NONE);
      var request = translate_page_item(TARGET_PAGE_TIPSTEXT, 'errrequest', '', ITEM_TYPE_NONE);
