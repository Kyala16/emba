...
$(document).ready(function () {
  ...
  fun_register_events();
  if (parseInt(localStorage.getItem('mobilestream'))) {
    $('#div_title_thirdstream').css('display', 'block');
    fun_get_thirdstream_parameters();
  } else {
    $('#div_title_thirdstream').css('display', 'none');
  }
});
function fun_register_events() {
  ...
  $('#button_video_refresh,#button_video_save,#button_video_reset').click(function () {
  ...
  $('#select_video_main_codec,#select_video_sub_codec,#select_video_third_codec').change(function () {
  ...
  $('#check_enable_video_workmode_hdr,#check_enable_video_workmode_fps').click(function () {
    var vhdr = $('#check_enable_video_workmode_hdr').prop('checked') ? 1 : 0;
    var vfps = $('#check_enable_video_workmode_fps').prop('checked') ? 1 : 0;
    if (vhdr === 1 && this.id.toString() === 'check_enable_video_workmode_hdr') {
      $('#check_enable_video_workmode_fps').prop('checked', false);
    } else if (vfps === 1 && this.id.toString() === 'check_enable_video_workmode_fps') {
...
function fun_multilang_adapter() {
  ...
  translate_page_item(TARGET_PAGE_SUB_VIDEO, 'codec', 'div_video_main_codec_name,div_video_third_codec_name', ITEM_TYPE_TEXT);
  translate_page_item(TARGET_PAGE_SUB_VIDEO, 'resolution', 'div_video_main_resolution_name,div_video_third_resolution_name', ITEM_TYPE_TEXT);
  translate_page_item(TARGET_PAGE_SUB_VIDEO, 'profile', 'div_video_main_profile_name,div_video_third_profile_name', ITEM_TYPE_TEXT);
  translate_page_item(TARGET_PAGE_SUB_VIDEO, 'frameratio', 'div_video_main_frame_rate_name,div_video_third_frame_rate_name', ITEM_TYPE_TEXT);
  translate_page_item(TARGET_PAGE_SUB_VIDEO, 'bitratetype', 'div_video_main_bitrate_type_name,div_video_third_bitrate_type_name', ITEM_TYPE_TEXT);
  translate_page_item(TARGET_PAGE_SUB_VIDEO, 'bitraterange', 'div_video_main_bitrate_reference_name,div_video_third_bitrate_reference_name', ITEM_TYPE_TEXT);
  translate_page_item(TARGET_PAGE_SUB_VIDEO, 'bitrate', 'div_video_main_bitrate_name,div_video_third_bitrate_name', ITEM_TYPE_TEXT);
  translate_page_item(TARGET_PAGE_SUB_VIDEO, 'quality', 'div_video_main_encode_quality_name,div_video_third_encode_quality_name', ITEM_TYPE_TEXT);
  translate_page_item(TARGET_PAGE_SUB_VIDEO, 'keyframe', 'div_video_main_key_frame_name,div_video_third_key_frame_name', ITEM_TYPE_TEXT);
  ...
  translate_page_item(TARGET_PAGE_SUB_VIDEO, 'smartenc', 'div_video_main_smartenc_name,div_video_sub_smartenc_name,div_video_third_smartenc_name', ITEM_TYPE_TEXT);
  translate_page_item(TARGET_PAGE_SUB_VIDEO, 'withaudio', 'div_video_main_withaudio_name,div_video_sub_withaudio_name,div_video_third_withaudio_name', ITEM_TYPE_TEXT);
  ...
  translate_page_item(TARGET_PAGE_COMMON, 'refresh', 'button_video_refresh,button_video_workmode_refresh,button_thirdstream_refresh', ITEM_TYPE_VALUE);
  translate_page_item(TARGET_PAGE_COMMON, 'save', 'button_video_save,button_video_workmode_save,button_thirdstream_save', ITEM_TYPE_VALUE);
...
(g_thirdstream_minbit = 0), (g_thirdstream_maxbit = 0);

function fun_initialize_pageui(flags, mainresolution, subresolution, thirdresolution, bupdate) {
  if (flags & 1) {
...
function fun_save_video_workmode_parameters() {
  var vhdr = $('#check_enable_video_workmode_hdr').prop('checked') ? 1 : 0;
  var vfps = $('#check_enable_video_workmode_fps').prop('checked') ? 1 : 0;
  var targetxml = '<?xml version="1.0" encoding="utf-8"?>' + '<request>' + '<videowork ver="2.0">' + '<hdr>' + vhdr + '</hdr>' + '<highfps>' + vfps + '</highfps>' + '</videowork>' + '</request>';
